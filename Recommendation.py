...
l1=["back_pain","constipation","abdominal_pain","diarrhoea","mild_fever","yellow_urine","yellowing_of_eyes","acute_liver_failure",
    ...
    "red_sore_around_nose","yellow_crust_ooze","vomiting"]

# LIST OF DISEASES
disease=["Invalid_Symptom","Allergy","GERD","Chronic cholestasis","Drug Reaction","Peptic ulcer disease","AIDS","Diabetes",
         "Gastroenteritis","Bronchial Asthma","Hypertension","Migraine","Cervical spondylosis","Paralysis","problems with lower gastrointestinal track",
         "Malaria","Chicken pox","Muscle stiffness or severe workout","Typhoid","Hepatitis A","Hepatitis B","Hepatitis C","Hepatitis D",
